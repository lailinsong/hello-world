					...
					<div class="col-md-3">
						<div class="add-article-box">
							...
							<div class="add-article-box-content">
								<input type="text" id="keywords" class="form-control" placeholder="输入新关键字" name="keywords" autocomplete="off">
						...
						<div class="add-article-box">
							...
							<div class="add-article-box-content">
								<input type="text" id="tags" class="form-control" placeholder="输入新标签" name="tags" autocomplete="off">
						...
						<div class="add-article-box">
							...
							<div class="add-article-box-content">
								...
								<p><label>公开度：</label><input type="radio" id="visibility" name="visibility" value="0" checked/>公开 <input type="radio" name="visibility" value="1" />加密</p>
								<p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" id="time" name="time" value="2018-10-19 17:29:37" /></span></p>
							</div>
							<div class="add-article-box-footer">
		...
		$.post("/blog/addArticle",
				...
				function(data){
					if(data == 1){
						...
						//clear("tags");
						//clear("pictureUpload");
						/* if($('input:radio[name="visibility"]:checked').val() == 1){
							$("#visibility").setAttr("checked");
						} */
					}else{
						alert("未知错误！");
					}
