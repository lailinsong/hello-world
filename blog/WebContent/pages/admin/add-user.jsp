	...
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
			<div id="info" class="row">
				...
				<div class="col-md-4">
					<form action="/blog/addUser" method="post" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="phone" class="form-control" name="phone" placeholder="请输入电话">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select id="grade" class="form-control" name="role">
...
$("#submit").click(function(){
	if(flag == 1){
		$.post("/blog/addUser",{id:"1",name:$("#name").val(),userName:$("#username").val(),phone:$("#phone").val(),password:$("#password").val(),grade:$("#grade").val(),loginTime:getDate()},function(data){
			if(data == 1){
				alert("添加成功！");
				clear("name");
				clear("username");
